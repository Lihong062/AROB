"""Module for Driver class, by Marc Howard and Miriam Melnick."""
...
class Driver(object):
    ...
    def stop(self):
        """Change the goal to now stop."""
        self.direction = Direction.STOP
        self.motor_speed = 0

    def go_straight(self, speed):
        """Change the goal to now go straight."""
        self.direction = Direction.STRAIGHT
        self.motor_speed = self._safety_cap_speed(speed)

    def turn_right(self, speed):
        """Change the goal to now turn right."""
        self.direction = Direction.RIGHT
        self.motor_speed = self._safety_cap_speed(speed)

    def turn_left(self, speed):
        """Change the goal to now turn left."""
        self.direction = Direction.LEFT
        self.motor_speed = self._safety_cap_speed(speed)

    def go_backwards(self, speed):
        """Change the goal to now go backwards."""
        self.direction = Direction.BACKWARDS
        self.motor_speed = self._safety_cap_speed(-speed)
    # End goal-changing functions
